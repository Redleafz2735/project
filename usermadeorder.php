                                        ...
                                        <table id="myTable" class="table table-bordered table-striped"> 
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $user_id = $_SESSION['user_id'];
                                                    $sql = $userorder->madeOrderUser1($user_id);
                                                    while($row = mysqli_fetch_array($sql)) {
                                                ?>
                                                <tr>
                                                    <td><?php echo $row['fullname']; ?></td>
                                        ...
                                        <table id="myTable" class="table table-bordered table-striped"> 
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $user_id = $_SESSION['user_id'];
                                                    $sql = $userorder->madeOrderUser2($user_id);
                                                    while($row = mysqli_fetch_array($sql)) {
                                                ?>
                                                <tr>
                                                    <td><?php echo $row['fullname']; ?></td>
                                        ...
                                        <table id="myTable" class="table table-bordered table-striped"> 
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $user_id = $_SESSION['user_id'];
                                                    $sql = $userorder->madeOrderUser3($user_id);
                                                    while($row = mysqli_fetch_array($sql)) {
                                                ?>
                                                <tr>
                                                    <td><?php echo $row['fullname']; ?></td>
                                        ...
                                        <table id="myTable" class="table table-bordered table-striped"> 
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $user_id = $_SESSION['user_id'];
                                                    $sql = $userorder->madeOrderUser4($user_id);
                                                    while($row = mysqli_fetch_array($sql)) {
                                                ?>
                                                <tr>
                                                    <td><?php echo $row['fullname']; ?></td>
                                        ...
                                        <table id="myTable" class="table table-bordered table-striped"> 
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $user_id = $_SESSION['user_id'];
                                                    $sql = $userorder->madeOrderUser5($user_id);
                                                    while($row = mysqli_fetch_array($sql)) {
                                                ?>
                                                <tr>
                                                    <td><?php echo $row['fullname']; ?></td>
                                        ...
                                        <table id="myTable" class="table table-bordered table-striped"> 
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $user_id = $_SESSION['user_id'];
                                                    $sql = $userorder->madeOrderUser6($user_id);
                                                    while($row = mysqli_fetch_array($sql)) {
                                                ?>
                                                <tr>
                                                    <td><?php echo $row['fullname']; ?></td>
