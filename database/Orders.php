...
class Testorders
{
    ...
    public function Orderinnerjoin() {
        ...
        "SELECT order_details.id,order_details.order_id,users.fullname,product.item_name,product.item_price,users.address,order_details.quantity,orders.created_at,order_details.status FROM order_details
